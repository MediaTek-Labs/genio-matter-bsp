...
Usage:          GCC: In your GCC project mk file, such as feature.mk, please set MTK_MBEDTLS_CONFIG_FILE to the configuration file
                     wanted, for example "MTK_MBEDTLS_CONFIG_FILE = config-mtk-homekit.h". To use hardware algorithm, please set
                     MTK_MBEDTLS_HW_CRYPTO definition in mbedtls config file.
                     In your GCC project Makefile, please add the following path:
