...
In the development branch of Mbed TLS, the Visual Studio solution files need to be generated first as described in [?úGenerated source files in the development branch?ù](#generated-source-files-in-the-development-branch).
