...
# ifndef OPENSSL_NO_DEPRECATED_3_0
#  if defined(MTK_CRYPTO_DEBUG)
#   include <stdio.h>
#   define ERR_PUT_error(l,f,r,fn,ln) printf("SAE: lib:%d, %s, %d\n", l, fn, ln)
#  else
#   define ERR_PUT_error(l,f,r,fn,ln)
#  endif
# endif
...
# define ERR_raise_data                                         \
    (ERR_new(),                                                 \
     ...
     ERR_set_error)
#else
# define ERR_raise(lib, reason)  ERR_PUT_error(ERR_LIB_BN,(lib),(reason),OPENSSL_FILE,OPENSSL_LINE) 
#endif
# ifndef OPENSSL_NO_DEPRECATED_3_0
