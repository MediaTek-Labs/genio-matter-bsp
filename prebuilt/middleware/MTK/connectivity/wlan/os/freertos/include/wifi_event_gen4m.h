...
#define WIFI_EVENT_ID_IOT_REMAIN_ON_CHANNEL 0x10
#define WIFI_EVENT_ID_IOT_CANCEL_REMAIN_ON_CHANNEL 0x20
#define   WIFI_EVENT_ID_IOT_USER_NOTIFY_P2P_EVENT   0x9a
#endif
...
/* EAP UID, need wait*/
#define   WIFI_EVENT_ID_IOT_SET_WPAUID_WAIT     0x54

/* EAP load CA*/
#define   WIFI_EVENT_ID_IOT_SET_WPAPWD_WAIT     0x55

/* EAP type, need wait*/
#define   WIFI_EVENT_ID_IOT_SET_EAP_WAIT        0x56

/* EAP load certificate */
#define   WIFI_EVENT_ID_IOT_SET_LOAD_CERT_WAIT  0x57

/* EAP load CA*/
#define   WIFI_EVENT_ID_IOT_SET_WPAPKPWD_WAIT   0x58
