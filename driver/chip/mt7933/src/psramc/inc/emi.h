...
#ifdef FLASH_TOOL_DA
#include "sw_types.h"
#else /* #ifdef FLASH_TOOL_DA */
#include "typedefs.h"
#endif /* #ifdef FLASH_TOOL_DA */
#include "dramc_common.h"
#if !__ETT__ && (FOR_DV_SIMULATION_USED == 0)
//#include "boot_device.h"
#endif /* #if !__ETT__ && (FOR_DV_SIMULATION_USED == 0) */

#if !__ETT__
#if (FOR_DV_SIMULATION_USED==0)
//#define DDR_RESERVE_MODE
//#define COMBO_MCP             // don't use COMBO_MCP
//#define DRAM_BASE 0xa0000000ULL
...
extern int pemi_setting_index;
extern EMI_SETTINGS pemi_settings[];
extern EMI_SETTINGS default_pemi_setting;
...
{
#if SUPPORT_TYPE_PSRAM
    EMI_SETTINGS *emi_set = &default_pemi_setting;

    if (pemi_setting_index != -1)
        emi_set = &pemi_settings[pemi_setting_index];
    return emi_set;
...
#define HQA_VCORE_HV_LP3_KOPP4  737500
...
#define HQA_VCORE_NV_LP3_KOPP4  700000
...
#define HQA_VCORE_LV_LP3_KOPP4  662500
...
#define HQA_VDDQ                _SEL_PREFIX(VDDQ, HV, LP4)
#define HQA_VIO18       _SEL_VIO18(HV)
#else /* #if defined(HVCORE_HVDRAM) */
#error "Please set HQA voltage type"
#endif /* #if defined(HVCORE_HVDRAM) */
...
#endif /* #if !defined(BOOTDEV_UFS) && !defined(BOOTDEV_SDMMC) */
#endif /* #if !__ETT__ */
...
#endif /* #if (CFG_BOOT_DEV == BOOTDEV_UFS) */
...
#endif /* #ifdef LAST_EMI */

#endif /* #ifndef MT_EMI_H */
